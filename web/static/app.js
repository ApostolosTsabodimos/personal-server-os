        ...
        />
            ...
            {showBackupModal && selectedService && (
                ...
                <div className="footer-info">
                    <span style={{color: 'var(--text-dim)', fontSize: '0.9rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem'}}>
                        Personal Server OS • {new Date().getFullYear()}
                        <a
                            href="https://github.com/ApostolosTsabodimos/personal-server-os"
                            target="_blank"
                            ...
                            onMouseEnter={(e) => {
                                ...
                                e.currentTarget.style.filter = 'brightness(1.5) drop-shadow(0 0 8px rgba(88, 166, 255, 0.5))';
                                e.currentTarget.querySelector('svg').style.animation = 'spin 0.6s ease-in-out';
                            }}
                            onMouseLeave={(e) => {
                        ...
                        >
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" style={{transition: 'all 0.3s ease'}}>
